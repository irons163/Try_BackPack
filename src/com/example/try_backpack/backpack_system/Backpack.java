...
import com.example.try_backpack.BitmapUtil;
import com.example.try_backpack.backpack_system.Tool.ToolCallback;
...
//			BackpackCeil backpackCeil = new BackpackCeil(BitmapUtil.backpack_cell_bg, cellWidth + witchCol*cellWidth, cellHeight + witchRow*cellHeight, false);
			BackpackCeil backpackCeil = new BackpackCeil(BitmapUtil.backpack_cell_bg, cellWidth + witchCol*cellWidth, cellHeight + witchRow*cellHeight, 1,false);
			addChild(backpackCeil);
			backpackCeil.setToolCallback(toolCallback);
			backpackCeils.add(backpackCeil);
//			backpackCeil.setAnchorPoint(0f, 0f);
//			backpackCeil.setAnchorPoint(0.5f, 0.5f);
			backpackCeil.setAnchorPoint(1f, 1f);
//			backpackCeil.setAnchorPoint(1.2f, -1.2f);
//			backpackCeil.setXscale(-1.5f);
			backpackCeil.setXscale(1f);
			backpackCeil.setYscale(1f);
		}
	}
