...
public class ViewGroupLayer extends ALayer{
	private ViewGroup view;
	
	protected ViewGroupLayer(Context context, float x, float y, boolean autoAdd) {
		super(x, y, autoAdd);
...
//		view.setla
		...
		((Activity)context).addContentView(view, new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT));
	}
...
//		view.draw(canvas);
	...
	public boolean onTouchEvent(MotionEvent event) {
		// TODO Auto-generated method stub
		boolean isTouch = view.onTouchEvent(event);
		isTouch = view.dispatchTouchEvent(event);
		return isTouch;
//		return false;
	}
...
//		 TODO Auto-generated method stub
	...
	public void addChild(ViewLayer layer) {
		// TODO Auto-generated method stub
		super.addChild(layer);
		
		view.addView(layer.getView());
	}
